...
import { FindInPageOptions, Response, WebContents, WebviewTag } from 'electron';
...
type OnBeforeRequestDelegate = (details: any) => Promise<Response | undefined>;
type OnHeadersReceivedDelegate = (details: any) => { cancel: boolean; } | undefined;
